...
const NotificationCard = ({ noti }) => {
    ...
    return (
        <div className='w-full flex justify-between items-center p-[5px] min-h-[50px] bg-gray-800 rounded-full cursor-pointer'>
            ...
            <div className='w-[40px] h-[40px] rounded-full overflow-hidden border-4 border-black'>
                {
                    noti.loop
                        ...
                        : noti?.post?.mediaType === "image"
                            ...
                            : noti?.post
                                ? <video src={noti.post.media} muted  className="h-full w-full object-cover" />
                                : null
                }
            </div>
