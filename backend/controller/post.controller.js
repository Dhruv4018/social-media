...
export const uploadPost = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "post create error", error })
    }
}
...
export const like = async (req, res) => {
    try {
       ...
       // console.log(postId);
        ...
        return res.status(500).json({ message: "liked posts error", error })
    }
}
...
export const comment = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "comments posts error", error })
    }
}
...
export const saved = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "user saved error", error })
    }
}
